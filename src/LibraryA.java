 ...
 * @author ANTONIO
 */
public class LibraryA extends Welcome{
    public LibraryA(){
                ...
                frameA.setTitle("JTatto");
                frameA.setSize(400, 200);
                frameA.setLocation(850, 100);
                ...
                JLabel title0 = new JLabel("Librería JTatto con tema oscuro (HiFiLookAndFeel) ", JLabel.CENTER);
